    ...
    <template v-slot:top>
      <v-toolbar flat>
                ...
                <v-container>
                  <v-row>
                    <v-col cols="8" sm="6" md="4">
                      <v-select v-model="atributo.tipo" :items="items" :rules="[v => !!v || 'Item obrigatório!']"
                        label="tipo" required></v-select>
                    </v-col>
                    <v-col cols="8" sm="6" md="4">
                      <v-text-field v-model="atributo.login" :items="items" :rules="[v => !!v || 'Item obrigatório!']"
                        label="Login" required></v-text-field>
                    </v-col>
                    <v-col cols="8" sm="6" md="4">
                      <v-select v-model="atributo.campus" :items="items" label="Campus"></v-select>
                    </v-col>
                    <v-col cols="8" sm="6" md="4">
                      <v-select v-model="atributo.curso" :items="items" label="Curso"></v-select>
                    </v-col>
                  </v-row>
                </v-container>
              </v-form>
        ...
        <v-dialog v-model="dialogDesativar" max-width="400px">
          <v-card>
            <v-card-title class="text-h5">Deseja {{ mudarStatus }} este usuário? </v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
